      ...
      <CardContent className="space-y-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="text-blue-300 hover:text-blue-200 text-sm font-semibold transition-colors hover:underline neon-glow"
            >
              Forgot Password?
            </button>
          </div>
          ...
          {/* Error Message */}
          {error && (
            <div className="flex items-center gap-3 notification-error text-white px-4 py-3 rounded-xl animate-shake">
        ...
        <div className="notification-info text-white rounded-xl p-4">
          <h4 className="font-semibold mb-2">Account Setup Required</h4>
          <p className="text-sm mb-3">
            Create accounts in your Supabase project to test different user roles:
          </p>
          <div className="space-y-2 text-xs">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 bg-red-400 rounded-full neon-glow"></span>
              <span><strong>Admin:</strong> Any email ending with @admin.com</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 bg-green-400 rounded-full neon-glow-green"></span>
              <span><strong>Staff:</strong> Any email ending with @staff.com</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 bg-purple-400 rounded-full neon-glow-purple"></span>
